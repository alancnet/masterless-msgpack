...
var debug = require('debug')('masterless');
var heartbug = require('debug')('masterless:heartbeat');
...
function onlocalconn(conn, callback) {
  ...
  function unbind(ignoreErrors) {
    ...
    conn.stream.removeListener('data', ondata);
